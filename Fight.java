...
public class Fight
{
 ...
 //Returns a String Variable Result to StoryStart displaying a message of who won the fight at the bottom.
   public String StartFight(Player player, Enemy boss)
   {
      ...
      int PlayerRoll = 0;
      int answer;
      //variable for setting player Armor.
      int playerArmor = 0;
              ...
              if(PlayerRoll < BossRoll)
                 {
                   ...
                   if(RollDifference > 3)
                   {
                      //get player armor and assign it to playerArmor
                      playerArmor = player.getArmor();
                      //pass playerArmor to CriticalHit function/method as second argument to determine the amount of damage reduction/amount of hp to return.
                      player.health = boss.CriticalHit(player.health,playerArmor);
                      
                      //checks to see which message to display based on player's armor.
                      if(playerArmor == 5)                    
                      JOptionPane.showMessageDialog(null,"Because Player Has 5 armor,Damage has been reduced by 5.");
                      else if(playerArmor == 10)
                      JOptionPane.showMessageDialog(null,"Because Player Has 10 armor,Damage has been reduced by 10.");
                      else if(playerArmor == 15)
                      JOptionPane.showMessageDialog(null,"Because Player Has 15 armor,Damage has been reduced by 15.");
                      else if(playerArmor == 20)
                      JOptionPane.showMessageDialog(null,"Because Player Has 20 armor,Damage has been reduced by 20.");
                      else if(playerArmor == 25)
                      JOptionPane.showMessageDialog(null,"Because Player Has 25 armor,Damage has been reduced by 25.");
                      else
                      JOptionPane.showMessageDialog(null,"Because Player Has 0 armor,Damage has been reduced by 0.");
                   ...
                   else if(RollDifference > 1)
                   {
                      //get player armor and assign it to playerArmor
                      playerArmor = player.getArmor();
                      //pass playerArmor to HighHit function/method as second argument to determine the amount of damage reduction/amount of hp to return.
                      player.health = boss.HighHit(player.health,playerArmor);
                      //checks to see which message to display based on player's armor.
                      if(playerArmor == 5)                    
                      JOptionPane.showMessageDialog(null,"Because Player Has 5 armor,Damage has been reduced by 5.");
                      else if(playerArmor == 10)
                   ...
                   else if(RollDifference > 0)
                   {
                        //get player armor and assign it to playerArmor
                        playerArmor = player.getArmor();
                        //pass playerArmor to lowHit function/method as second argument to determine the amount of damage reduction/amount of hp to return.
                        player.health = boss.lowHit(player.health,playerArmor);
                        //checks to see which message to display based on player's armor.
                      if(playerArmor == 5)                    
                      JOptionPane.showMessageDialog(null,"Because Player Has 5 armor,Damage has been reduced by 5.");
                      else if(playerArmor == 10)
